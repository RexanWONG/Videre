...
import { BsCameraVideo, BsKeyFill } from "react-icons/bs";
...
const Form = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center font-raleway">
      <div className="mt-">
        <h1 className="font-bold font-montserrat">Upload Video Content</h1>
      </div>
        ...
        <form>
          ...
          <div>
            <div className="flex flex-row items-center justify-center gap-4">
              ...
              {videoInserted && uploadedOntoIpfs ? (
                <h1 className="text-green-600 mb-5">
          ...
          <div>
            <div className="flex flex-row items-center justify-center gap-4">
              ...
              <span>
                <label className="font-bold">List of keywords</label>
                <div className="flex">
                  <input
                    type="text"
                ...
                <ul>
                  ...
                  <li key={index} className="mb-2 text-lg flex items-center"> {/* Updated class name and added flex class */}
                  - {keyword}
                    </li>
                  ))}
                </ul>
