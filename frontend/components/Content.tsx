...
const Content = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10 font-raleway">
      <button
        onClick={getVideosWithLikes}
        className="flex items-center justify-center text-xl font-bold border-2 border-black rounded-lg p-1 hover:bg-black hover:text-white"
      >
        <IoMdRefresh className="mr-2 transition-all duration-500 ease-in-out" />
        Refresh
      </button>
      <div className="mt-16">
